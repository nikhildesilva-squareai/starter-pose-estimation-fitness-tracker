...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![Computer Vision](https://img.shields.io/badge/course-Computer%20Vision-0056CE) ![14 hours](https://img.shields.io/badge/estimated-14h-lightgrey)

> **Square 1 AI** starter template — Computer Vision

## Overview

In this intermediate-level project, you'll build a **Pose Estimation Fitness Tracker** using Python, MediaPipe, OpenCV. Track body poses in real-time and count exercise repetitions. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-pose-estimation-fitness-tracker.git
cd starter-pose-estimation-fitness-tracker
